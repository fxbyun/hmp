            ...
            $('#mobile').typeahead({
                ...
                templates: {
                    ...
                    'suggestion': function (o) {
                        ...
                        var div = "<div onclick='commit()' style='border-bottom-color:#66afe9;border-bottom-style:dashed;'>{0} - <strong>{1}</strong> – {2}</div>";
...
<div style="margin: 2em 2em; line-height: 2.8em;" class="text-center">
    ...
    <div class="form-group clearfix" style="line-height: 2em;">
        ...
        <input type="text" id="mobile" maxlength="11" class="form-control" style="float:left; width: 120%; left: -20px;"
               placeholder="请输入手机号">
    </div>
