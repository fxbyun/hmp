...
public class WeixinUtil {
    ...
    public final static String GET_TICKET = propertiesLoader.getProperty("jsapi_ticket");
    ...
    public static String getTicket(String accessToken) {
        String requestUrl = GET_TICKET.replace("ACCESS_TOKEN", accessToken);
        System.out.println(requestUrl);
        JSONObject jsonObject = httpRequest(requestUrl, "GET", null);
        String ticket = null;
        // 如果请求成功
        if (null != jsonObject) {
            try {
                ...
                // 获取token失败
                log.error("获取ticket失败 errcode:{} errmsg:{}", jsonObject.getIntValue("errcode"), jsonObject.getString
                        ("errmsg"));
            }
        }
        return ticket;
