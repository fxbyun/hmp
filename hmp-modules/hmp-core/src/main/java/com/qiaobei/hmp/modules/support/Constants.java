...
public final class Constants {
    ...
    public static int PAGZ_SIZE = 10;

    public static int TAG_PAGZ_SIZE = 30;

    //时间格式
    //文件大小
    public static final int maxFileSize = 2097152;
    ...
    public static final int APPOINT_PAGE_SIZE = 10;
}
