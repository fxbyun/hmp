...
public class ConstantsController extends BaseController {
    ...
    static final EnumMap<Gender, String> GENDER_MAP = Maps.newEnumMap(Gender.class);

    static final Map<String, String> GROUP_ARRYS = Maps.newHashMap();
    static final List<String> XW_ARRYS = Lists.newArrayList();


    private static final List<String> MEDICINE_USE_MODE_LIST = Lists.newArrayList();
    private static final List<String> MEDICINE_USING_TIME_LIST = Lists.newArrayList();
    private static final List<String> MEDICINE_USE_TIMES_LIST = Lists.newArrayList();
    private static final List<String> WESTERN_MEDICINE_CATE_LIST = Lists.newArrayList();
    private static final List<String> CHINESE_MEDICINE_CATE_LIST = Lists.newArrayList();

    private static final List<String> MEDICINE_USE_MODE__NEED_ALONE_PRINT_LIST = Lists.newArrayList();
