...
<div>
    <div style="margin-top: 1rem;">
        <div>
            <form id="presForm" action="${ctx}/learn/templatePrescription?type=lib" method="post">
                <input type="hidden" id="pageInput" name="page" value="${rpPage.number}">
                <p class="text-center">
                    <span>药方类型</span>
                    <select name="medicineType" class="form-control" style="width: 60%; display: inline-block;">
                ...
                <p class="text-center">
                    <span>药方名称</span>
                    <input name="name" value="${name}" type="text" class="form-control" placeholder="默认全部"
                           style="width: 60%; display: inline-block;">
                </p>

                <p class="text-center btn-boxs">
                    <button type="submit" class="btn btn-default" onclick="javascript:$('#pageInput').val('0')">搜索
                    </button>
                </p>
            </form>
        </div>
...
<script>
    ...
    function fn_detailShow(id) {
        window.location.href = "${ctx}/learn/detailPrescription/" + id;
    }
