...
<nav class="nav-tabs nav-wx" id="headerDiv">
    <ul>
        <li id="entryPre"><a href="${ctx}/learn/index">录入药方</a></li>
        <li id="templatePre"><a href="${ctx}/learn/templatePrescription?type=lib">模板药方</a></li>
        <li id="myPre"><a href="${ctx}/learn/templatePrescription">我的药方</a></li>
    </ul>
</nav>
