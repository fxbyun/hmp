        ...
        <div class="col-xs-12 col-md-12">
            <form id="searchForm" action="${ctx}/retail/medicBuyDetails" method="post">
                <div class="form-inline form-group">
                    ...
                    <input type="text" class="form_day" name="startDate"
                           value="<fmt:formatDate value="${startTime}" pattern="yyyy/MM/dd"/>"
                           class="form-control form_date2" id="txtStartDate" readonly="">
                    至
                    <input type="text" class="form_day" name="endDate"
            ...
            <div class="form-group" style="height: 420px; overflow-y: auto;">
                ...
                <%--<div class="panel panel-success">
                    <div class="panel-heading">
                        <h3 class="panel-title"><span>2017-01-22 14:20</span><span>福生门诊</span><span>张丽丽</span>护士</h3>
                    </div>
                    <div class="panel-body">
                        <strong class="panel-title">西药及中成药</strong>
                        <p>1、沙丁胺醇注射液<span>1.0ml</span></p>
                        <p>2、小儿热速清糖浆<span>1.0支</span></p>
                        <strong class="panel-title">中草药房</strong>
                        <p>1、冬虫夏草</p>
                        <p>2、黄莲</p>
                    </div>
                ...
                <div class="panel panel-success">
                    <div class="panel-heading">
                        <h3 class="panel-title"><span>2017-01-22 14:20</span><span>福生门诊</span><span>李胖胖</span>护士</h3>
                    </div>
                    <div class="panel-body">
                        <strong class="panel-title">西药及中成药</strong>
                        <p>1、沙丁胺醇注射液<span>1.0ml</span></p>
                        <p>2、小儿热速清糖浆<span>1.0支</span></p>
                        <p>3、小儿热速清糖浆<span>1.0支</span></p>
                        <p>4、小儿热速清糖浆<span>1.0支</span></p>
                        <strong class="panel-title">中草药房</strong>
                        <p>无</p>
                    </div>
                </div>--%>
