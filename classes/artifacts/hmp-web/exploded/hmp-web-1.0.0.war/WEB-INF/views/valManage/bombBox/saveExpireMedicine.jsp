    ...
    <div class="tag-medicine">
        ...
        <div class="content-right text-right">
                ...
                <select name="detailId" id="validityDate" class="form-control">
                    <c:forEach items="${details}" var="detail" varStatus="status">
                        <c:if test="${status.index==0}">
                            <option value="${detail.id}" selected="selected"><fmt:formatDate value="${detail.validityDate}" pattern="yyyy/MM/dd"/></option>
                        </c:if>

                        <c:if test="${status.index!=0}">
                            <option value="${detail.id}"><fmt:formatDate value="${detail.validityDate}" pattern="yyyy/MM/dd"/></option>
                        </c:if>
                    </c:forEach>
                </select>
            </p>
            ...
            <p>
                ...
                <input type="number" min="1" name="totalNumber" value="" class="form-control " hmp-input-number id="lossNumber">
            </p>
...
<script>
    $(function () {
        ...
        $("#saveIaiDetail").click(function () {
            ...
            var url = "${ctx}/IaiLossManage/bombBox/saveMedTag";
