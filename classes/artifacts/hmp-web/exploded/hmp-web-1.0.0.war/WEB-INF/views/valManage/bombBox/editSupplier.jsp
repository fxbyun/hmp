...
<div class="editSupplier">
            ...
            <c:if test="${not empty supplierList}">
                <c:forEach items="${supplierList}" var="supplier">
                    <tr>
                        <td>${supplier.name}</td>
                        <td>
                            <button class="btn btn-default" onclick="fn_EditSupplier(${supplier.id})" style="margin-right: 5px; width: 80px;">
                                编辑
                            </button>
                            <button class="btn btn-default" onclick="delSupplier(this,${supplier.id})"><i class="fa fa-trash-o"></i> 删除
                            </button>
                        </td>
                    </tr>
                </c:forEach>
    ...
    <p class="text-center" style="margin-top: 20px;">
        ...
        <button id="btnCloseSupplier" class="btn btn-default" type="button" style="width: 80px; margin-left: 10px;">关闭</button>
    </p>
</div>
<script>
    $(function () {
