    ...
    <div class="tag-medicine">
        ...
        <div class="content-right text-right">
            <p>
                ...
                <input type="text" name="validityDate" value="<c:if test="${not empty detail}"><fmt:formatDate value="${detail.validityDate}" pattern="yyyy/MM/dd"/></c:if>" class="form-control form_day" readonly disabled id="validityDate">
            </p>
            <p>
            ...
            <p>
                ...
                <input type="number" min="0" value="<c:if test="${not empty medPrivate}">${medPrivate.price}</c:if>" name="price" class="form-control" id="price">
            </p>
            <p>
                <label for="totalNumber">库存数量</label>
                <input type="number" min="1" name="stockNum" value="<c:if test="${not empty detail}">${stockNum}</c:if>" class="form-control " id="totalNumber">
            </p>

            <p>
                <label for="warnLine">预警线</label>
                <input type="number" name="warnLine" min="1" value="<c:if test="${not empty detail}">${detail.warnLine}</c:if>" class="form-control " id="warnLine">
            </p>
        </div>
    </div>
</form>
