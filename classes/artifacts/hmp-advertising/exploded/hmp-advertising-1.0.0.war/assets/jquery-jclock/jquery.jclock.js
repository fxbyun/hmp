(function ($) {
    ...
    $.fn.jclock.displayTime = function (el) {
        ...
        //TODO  复写方法 每秒更新页面上面的值
        $(jclockOption.dateId).html(date);
        ...
        $(jclockOption.timeId).html(nowDate.getHours() + ":" + mi);
        $(jclockOption.oldChinaDateId).html
        (jclockOption.oldChinaDateObj.gzYear +
            jclockOption.oldChinaDateObj.IMonthCn +
            jclockOption.oldChinaDateObj.IDayCn
        );
    ...
    $.fn.jclock.getDate = function () {
        if ($.fn.jclock.withDate == true) {
            ...
            date = ((date < 10) ? "0" : "") + date;
            jclockOption.oldChinaDateObj = calendar.solar2lunar(year, month, date);
