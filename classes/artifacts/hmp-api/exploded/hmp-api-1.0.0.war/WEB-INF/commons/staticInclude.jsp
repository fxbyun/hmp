...
<script type="text/javascript" src="${ctx}/assets/jquery-jclock/jquery.jclock.js"></script>
<script type="text/javascript" src="${ctx}/assets/jquery-jclock/calendar.js"></script>
<script type="text/javascript" src="${ctx}/assets/jquery-jclock/utf8ToGb2321.js"></script>
...
<%--<script type="text/javascript" src="${ctx}/assets/jquery-jsonp/jquery.jsonp.js"></script>--%>
