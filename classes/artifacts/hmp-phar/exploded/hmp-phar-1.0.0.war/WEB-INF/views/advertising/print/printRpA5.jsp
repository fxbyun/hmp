...
<head>
    ...
    <script type="text/javascript" src="${ctx}/assets/jpPrint/jQuery.print.js"></script>
...
<div class="main mCenter" style="min-height: 198mm; position: relative; padding: 0 20px;" id="printDiv">
    <table>
        <thead>
        <tr class="main-header pd_l ">
            <td colspan="4">
                <strong>${emr.doctor.outpatientService}处方笺</strong>
            </td>
        ...
        <tr class="main-sTitle" style="line-height: 1.5em;">
            <td colspan="2">
                <span>体征:</span>
                <input type="text" style="width: 11em" value="<c:forEach items="${emr.vitalSignList}" var="vs" varStatus="status"><c:if
        ...
        <tr style="line-height: 1.5em;">
            <td colspan="3">
                <span style="float: left">复诊：</span>

                <div class="fz">
                    <input type="radio" name="days" value="1"><span class="dia-span">1天</span>
                    <input type="radio" name="days" value="2"><span class="dia-span">2天</span>
                    <input type="radio" name="days" value="3"><span class="dia-span">3天</span>
                    <input type="radio" name="days" value="4">
                    <input id="thoerDays" class="dia-span" style="border-bottom:1px solid #777; width: 35%; ">
                </div>
            </td>
            <td>
                <div class="fz">
                    <input type="radio" name="times" value="1"><span class="dia-span">上午</span>
                    <input type="radio" name="times" value="2"><span class="dia-span">下午</span>
                </div>
            </td>
        </tr>
        <tr class="main-sTitle" style="line-height: 1.5em;">
