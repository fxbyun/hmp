...
<div class="container inspectManage">
    <ul class="navigation">
        <li class="active"><a href="${ctx}/adv/inspectManage" class="btn btn-default">待检查列表</a></li>
        <li><a href="${ctx}/adv/inspectManage?status=Have_Exam_Or_Lab" class="btn btn-default">已完成列表</a></li>
    </ul>
                    ...
                    <tr>
                        ...
                        <td>
                            <button class="btn btn-default" type="button"
                                    onclick="inspectionResult(${oneEmrJClass.id})">上传结果
                            </button>
                        </td>
                    </tr>
                </c:forEach>
