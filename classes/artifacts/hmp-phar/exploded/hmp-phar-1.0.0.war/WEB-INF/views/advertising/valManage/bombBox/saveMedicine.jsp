    ...
    <div class="tag-medicine">
        <div class="content-left text-right">
            ...
            <p>
                ...
                <input type="text" hmp-input-double
                       value="<c:if test="${not empty detail}">${detail.bayingPrice}</c:if>" name="bayingPrice"
                       class="form-control" id="bayingPrice">
            </p>
            <p>
                ...
                <select id="medUnit" name="medicineUnit" id="selMedicineUnit" class="form-control">
                    <c:forEach var="u" items="${medicineUnits}">
                        ...
                        <c:if test="${empty medPrivate}">
                            <option value="${u.key}"
                                    <c:if test='${med.useUnit==u.key}'>selected</c:if>>${u.value}</option>
                        </c:if>
        ...
        <div class="content-right text-right">
            ...
            <p>
                ...
                <input type="text" hmp-input-price
                       value="<c:if test="${not empty medPrivate}">${medPrivate.price}</c:if>" name="price"
                       hmp-input-double class="form-control" id="price">
            </p>
            <p>
                <label for="totalNumber">产品数量</label>
                <input type="text" hmp-input-double name="totalNumber"
            ...
            <p>
                ...
                <input type="text" name="warnLine" value="<c:if test="${not empty detail}">${detail.warnLine}</c:if>"
                       class="form-control " hmp-input-number id="warnLine">
            </p>
        </div>
    </div>
</form>
