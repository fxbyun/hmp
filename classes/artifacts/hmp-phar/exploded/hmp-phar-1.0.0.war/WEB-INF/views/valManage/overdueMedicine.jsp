        ...
        <div class="validityManage overdueMedicine tabbable">
            <div class="over-seach">
                <input type="text" name="medName" id="medName" value="${medName}" class="form-control"
                       style="display: inline; width: 25%;" placeholder="输入您要查询的药品名">
            ...
            <div class="tab-content">
                <div id="soonTable" class="tab-pane active">
                    ...
                    <div class="text-center">
                        <button type="button" onclick="fn_LoadRpList(${fastExpirePage.number - 1})"
                                class="btn btn-default">
                            上一页
                        </button>
                        <button type="button"
                                onclick="fn_LoadRpList(${fastExpirePage.number + 1},${fastExpirePage.totalPages})"
                ...
                <div id="isTable" class="tab-pane">
                    ...
                    <div class="text-center">
                        <button type="button" onclick="fn_LoadRpList(${expirePage.number - 1})" class="btn btn-default">
                            上一页
                        </button>
                        <button type="button" onclick="fn_LoadRpList(${expirePage.number + 1},${expirePage.totalPages})"
                                class="btn btn-default">下一页
                        </button>
                        <button type="button" class="btn btn-success">打印订单</button>
...
<script>
    $(function () {
        $("#btnSearch").click(function () {
            ...
            var url = "${ctx}/adv/validityManage/overdueMedicine?medName={0}".format(medName);
            location.href = url;
        })
    })
    ...
    function toAddLossDetail() {
        ...
        var page = 0;
        var url = "${ctx}/adv/IaiLossManage/saveIaiLoss?uuid={0}&&page={1}".format(addUUID, page);
        location.href = url;
    }

    function fn_GoDetail(page) {
        var medName = $("#medName").val();
        var url = "${ctx}/adv/validityManage/overdueMedicine?medName={0}&page={1}".format(medName, page);
        location.href = url;
    }
