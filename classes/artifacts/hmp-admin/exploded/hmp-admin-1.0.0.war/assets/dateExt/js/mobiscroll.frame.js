(function ($, window, document, undefined) {
    ...
    ms.classes.Frame = function (el, settings, inherit) {
        ...
        that.show = function (prevAnim, prevFocus) {
            ...
            var objLeft = $(".yijiazhen-date-tmpDiv").prev().offset().left;
            // Create wheels
            var html;
            ...
            html = '<div lang="' + s.lang + '" style="position:absolute" class="mbsc-' + s.theme + (s.baseTheme ? ' mbsc-' + s.baseTheme : '') + ' dw-' + s.display + ' ' +
                (s.cssClass || '') +
                (that._isLiquid ? ' dw-liq' : '') +
                (isOldAndroid ? ' mbsc-old' : '') +
                (hasButtons ? '' : ' dw-nobtn') + '">' +
                '<div class="dw-persp" style="left: ' + objLeft + 'px">' +
            ...
            //$(".yijiazhen-date-tmpDiv").append(that)
        ...
        that.init = function (ss) {
            ...
            if ($(".yijiazhen-date-tmpDiv").size() > 0) {
                $(".yijiazhen-date-tmpDiv").remove()
                ss.clickObj.after('<div class="yijiazhen-date-tmpDiv"></div>')
            } else {
                ss.clickObj.after('<div class="yijiazhen-date-tmpDiv"></div>')
            }
            ...
            s.context = ".yijiazhen-date-tmpDiv"
