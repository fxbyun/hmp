...
;(function (factory) {
    ...
    var default_options = {
        ...
        defaultTime: false,	// menu formatTime format (ex. '10:00' for formatTime:	'H:i')
        defaultDate: false,	// menu formatDate format (ex new Date() or '1986/12/08' or '-1970/01/05' or '-1970/01/05')
