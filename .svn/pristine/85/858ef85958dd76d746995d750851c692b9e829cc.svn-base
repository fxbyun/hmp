...
<script>
    $(function () {
        ...
        $("#btnSaveIaiInto").click(function () {
            //var iaiIntoId=$("#iaiIntoId").val();
            $.postJSON("${ctx}/adv/validityManage/replenishment/saveReplenish", {"iaiIntoId": iaiIntoId}, function (data) {
                if (data.success) {
    ...
    function fn_GoDetail(page) {
        ...
        var url = "${ctx}/adv/validityManage/goIaiIntoDetailRep?iaiIntoId={0}&page={1}".format(${iaiInto.id}, page);
        location.href = url;
    }
    ...
    function selectReplenishMed(name, page, iaiIntoId) {
        ...
        if (iaiIntoId == undefined) {
            url = "/adv/validityManage/bombBox/getReplenishMedList?name={0}&page={1}".format(name, page);
        } else {
            url = "/adv/validityManage/bombBox/getReplenishMedList?name={0}&page={1}&iaiIntoId={2}".format(name, page, iaiIntoId);
        }
