...
<div style="padding: 15px 20px;">
    ...
    <p class="text-right" style="margin: 12px 0 20px;">
        ...
        <button type="button" onclick="fn_LoadRpList(${replenishPage.number + 1},${replenishPage.totalPages})" class="btn btn-default">下一页</button>
    </p>
    <p class="text-center" style="margin: 0;">
        <button type="button" id="loadReplenish" class="btn btn-success" style="width: 70px; margin-right: 10px;">载入</button>
...
<script>
    $(function () {
        $("#loadReplenish").click(function () {
            ...
            var url = "${ctx}/validityManage/bombBox/loadReplenish";
    ...
    function fn_GoDetail(page) {
        var url = "${ctx}/validityManage/bombBox/showReplenish?page={0}".format(page);
        location.href=url;
    }
