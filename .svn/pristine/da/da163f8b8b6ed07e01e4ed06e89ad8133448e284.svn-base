...
<%--@elvariable id="doctorId" type="java.lang.long"--%>
<%--
    ...
    <div style="margin-top: 20px; padding: 0 25px;">
        ...
        <div class="form-group">
            ...
            <div class="col-xs-9 col-sm-9">
                    ...
                    <%--readonly="true" />--%>
                <form:input path="birthday" class="form-control form_date_age" id="txtBirthday" placeholder="生日"
                            readonly="true"/>
            </div>
        </div>
        <div class="form-group">
            ...
            <div class="col-xs-9 col-sm-9">
                <input type="radio" name="sex" class="radio-inline" title="">男
                <input type="radio" name="sex" class="radio-inline" title="">女
