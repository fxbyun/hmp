...
<div class="container">
        ...
        <table class="rp-table" width="100%">
            ...
            <tr>
                <td colspan="7" class="val-btn">
                    <input type="text" class="form-control" id="lossNo" value="${lossNo}"
            ...
            <tr onclick="showLoss()">
                <td>1</td>
                <td>SH2016110447-00000000</td>
                <td>2016-12-22</td>
                <td>200.0</td>
                <td><span class="val-text loss-text">备注内容</span></td>
                <td>丽丽</td>
                <td><a href="javascript:" onclick="deleteIaiLoss(this,${loss.id})">删除</a></td>
            </tr>
            <tr>
    ...
    <div class="text-center" style="margin-bottom: 20px;">
        ...
        <button type="button" onclick="fn_LoadRpList(${lossPage.number + 1},${iaiIntoPage.totalPages})"
...
<script>
    $(function () {
        $("#btnSearch").click(function () {
            ...
            var url = "${ctx}/adv/validityManage/lossRecord?lossNo={0}".format(lossNo);
    ...
    function showLoss(uuid) {
        <%--var url= "${ctx}/adv/IaiLossManage/saveIaiLoss?uuid={0}".format(uuid);--%>
        window.location.href = "${ctx}/adv/IaiLossManage/saveIaiLoss";
    }
