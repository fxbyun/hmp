...
<body style="padding:2px 0;font-size: 12px; background-color: #fff;" id="diii">
    ...
    <div style="min-height: 100mm;">
        <section class="main-contain" style="margin-top: -1em;height: 460px">
            ...
            <p><c:if test="${empty emr.mainSuit}">无</c:if> <c:if
                    test="${not empty emr.mainSuit}">${emr.mainSuit.replace(";","")}</c:if><c:if
                    test="${not empty emr.remarks}">${emr.remarks}</c:if></p>
            </p>
            ...
            <p style="    margin-top: 10px;margin-bottom: 10px;"> 初步诊断：<c:if
                    test="${empty emr.diagnosisResult}">无</c:if><c:if
    ...
    <div class="main-footer">
        ...
        <div class="main-footer ub pad-tb" style="border-top: 2px dotted #d8d8d8;">
            <div class="ub ub-f1 ub-ver tex-r mar-r1">
                ...
                <%--<h2 class="p-title" style=" display: inline-block;position: relative;left: 90px;"></h2>--%>
            </div>
            <div class="ub ub-f1 clearfix"
                 style="line-height: 1.8em;display: inline-flex;">
