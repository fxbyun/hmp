    ...
    <div class="container">
        <ul class="navigation">
            ...
            <ul class="navigation-sub">
                ...
                <li class="active"><a href="${ctx}/validityManage/entryRecord" class="btn btn-default">入货库记录</a></li>
            </ul>
        </ul>
        <div class="validityManage entryRecord">
            <table class="rp-table" width="100%">
                ...
                <tr>
                    <td colspan="7" class="val-btn">
                        <input type="text" name="goodsNo" id="goodsNo" value="${goodsNo}" class="form-control" style="display: inline; width: 25%;"
                               placeholder="输入您要查询的进货单单号">
                        <button class="btn btn-default" id="btnSearch" type="button">搜索</button>
                        <a class="btn btn-success" id="toAddIaiDetail" href="javascript:void(0);" onclick="toAddIaiDetail()">新增入库单</a>
                    </td>
                </tr>
                <tr>
                    <th>序号</th>
            ...
            <div class="text-center">
                ...
                <button type="button" onclick="fn_LoadRpList(${iaiIntoPage.number + 1},${iaiIntoPage.totalPages})" class="btn btn-default"
...
<script>
    ...
    function showDetail(uuid) {
        var url = "${ctx}/validityManage/saveValList?addUUID={0}".format(uuid);
        location.href=url;
    }
