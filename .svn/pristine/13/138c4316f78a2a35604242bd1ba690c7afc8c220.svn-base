...
<head>
    ...
    <script>
        ...
        function goToThisPage() {
            ...
            if (page == "")page = 1;
            if (page < 1)page = 1;
            var total = ${emrListPage.totalPages};
...
<div class="container chargeManage">
    <ul class="navigation">
        ...
        <li class="active"><a href="${ctx}/adv/pharmacyManage?status=Have_Dispensing" class="btn btn-default">已发药列表</a>
        </li>
    ...
    <form action="${ctx}/adv/pharmacyManage" method="post">
        ...
        <input id="status" type="hidden" name="status" value="Have_Dispensing"/>
        <div class="adv-container alreadyList">
            <div class="text-right">
                ...
                <button type="submit" class="btn btn-success" style="margin-right: 20px;" id="btnSubmit">搜索</button>
            </div>
            <table class="adv-table" width="100%">
                ...
                <c:forEach items="${emrListPage.content}" varStatus="status" var="one">
                    <tr>
                        ...
                        <td>
                                ${empty one.cashierName?one.doctor.name:one.cashierName}
                        </td>
                            <%--<td><span class="text-num" title="备注内容">备注内容</span></td>--%>
                        <td>
                            <button class="btn btn-default" type="button" onclick="hasMedicineDetails(${one.id})">退药
                            </button>
                            <div class="dropdown" style="width: 102px; display: inline-block;">
                                ...
                                <ul class="dropdown-menu">
                                    <li><a href="#" onclick="javascript:printA5ChuFang('A5打印','${one.id}')">打印处方笺</a>
                                    </li>
