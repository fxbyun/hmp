...
public class PrescriptionCategoryServiceImpl implements PrescriptionCategoryService {
    ...
    @Override
    public List<PrescriptionCategory> listPrescriptionCategoryByDoctor(Long doctorId) {
        return prescriptionCategoryDao.findByDoctorId(doctorId);
    }

    @Override
    public List<PrescriptionCategory> listPrescriptionLibCategory() {
        return prescriptionCategoryDao.findLibCategory();
    }
}
