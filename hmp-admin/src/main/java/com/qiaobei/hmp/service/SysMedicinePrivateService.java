 ...
 */
public interface SysMedicinePrivateService {
    ...
    List<MedicinePrivate> getMedicinePrivateByDoctor(Doctor doctor);

    void deleteMedicinePrivate(MedicinePrivate medicinePrivate);
}
