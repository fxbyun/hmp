...
public final class Utils {
     ...
     */
    public static void entryptUserPassword(Doctor user) {
    ...
    public static String encodePwd(String pwd, String salt) {
        byte[] hashPassword = Digests.sha1(pwd.getBytes(), Encodes.decodeHex(salt), Constants.PASSWORD_HASH_INTERATIONS);
