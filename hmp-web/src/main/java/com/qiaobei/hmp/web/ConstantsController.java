...
public class ConstantsController extends BaseController {
    ...
    static {
        ...
        VITAL_SIGN_LABELS.put(VitalSign.Type.Ot, "其他");
        ...
        VITAL_SIGN_UNITS.put(VitalSign.Type.Ot, "");
        ...
        list.add(new VitalSign(VitalSign.Type.Ot));
        ...
        netAlonePrint.add("冲洗/外用");
        //netAlonePrint.add("外用");
