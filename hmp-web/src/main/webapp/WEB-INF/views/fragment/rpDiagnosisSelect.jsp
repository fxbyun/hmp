...
<c:forEach var="tag" items="${diagnosisPage.content}">
    <span class="tag span-tag" style="width: auto;" onclick="fn_SelectDiagnosisTag('${tag.name}')">${tag.name}</span>
</c:forEach>
<div class="form-group text-right" style="margin-top: 10px;">
    <div class="col-sm-4 col-xs-4 col-lg-4 text-left">
        <label class="btn btn-warning">常用诊断</label>
        <button type="button" onclick="loadDiagnosisOthers(0)" class="btn btn-default"><i class="fa fa-external-link"></i> 诊断库</button>
    </div>
    ...
    <div class="col-sm-4 col-xs-4 col-lg-4">
        <div class="input-group">
            ...
            <span class="input-group-btn">
                <button onclick="fn_LoadRpDiagnosisTag()" class="btn btn-primary" type="button"><i class="fa fa-times"></i></button>
                <button onclick="loadDiagnoses(0)" class="btn btn-primary" type="button"><i class="fa fa-search"></i></button>
            </span>
        </div>
    </div>
</div>
