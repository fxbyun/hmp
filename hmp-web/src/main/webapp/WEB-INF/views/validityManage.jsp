    ...
    <div class="container">
        ...
        <div class="validityManage" id="KC_HTML">
            <table class="rp-table" width="100%">
                ...
                <tr>
                    ...
                    <td colspan="8" class="val-btn">
                        <input type="text" name="medName" id="medName" value="${medName}" class="form-control" style="display: inline; width: 25%;"
                               placeholder="输入您要查询的药品名">
                        <button id="btnSearch" class="btn btn-default" type="button">搜索</button>
                        <a class="btn btn-default" href="${ctx}/validityManage/overdueMedicine">过期提醒</a>
                        <a class="btn btn-default" id="replenishDetail" onclick="replenishDetail()">智能补货</a>
                        <a class="btn btn-default" href="${ctx}/validityManage/repOrders">智能订单</a>
                    </td>
                </tr>
                <tr>
                    <th>序号</th>
            ...
            <div class="text-center">
                ...
                <button type="button" onclick="fn_LoadRpList(${detailPage.number + 1},${detailPage.totalPages})" class="btn btn-default"
...
<script>
    $(function () {
        $("#btnSearch").click(function () {
            ...
            var url = "${ctx}/validityManage?medName={0}".format(medName);
            location.href = url;
        })
    })
    ...
    function replenishDetail() {
        ...
        var url = "${ctx}/validityManage/replenishment?uuid={0}".format(addUUID);
        location.href=url;
    }
    ...
    function fn_GoDetail(page) {
        var medName=$("#medName").val();
        var url = "${ctx}/validityManage?medName={0}&page={1}".format(medName,page);
        location.href=url;
    }
