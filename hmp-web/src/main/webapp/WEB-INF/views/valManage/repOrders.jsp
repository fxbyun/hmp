...
<div class="manage">
    <div class="container">
        ...
        <div class="validityManage entryRecord repOrders">
            ...
            <div class="text-center">
                ...
                <button type="button" onclick="fn_LoadRpList(${IaiIntoRepPage.number + 1},${IaiIntoRepPage.totalPages})" class="btn btn-default"
    ...
    <script>
        ...
        function showDetail(iaiIntoId) {
            var url = "${ctx}/validityManage/goIaiIntoDetailRep?iaiIntoId={0}".format(iaiIntoId);
            location.href=url;
        }
