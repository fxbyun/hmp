...
<form name="iaiLossDetail" id="lossDetailForm" action="${ctx}/IaiLossManage/bombBox/saveMedTag" method="post">
    <div class="tag-medicine">
        <div class="content-left text-right">
            <p>
                <label for="medName">药品名称</label>
                <input type="text" name="MedicineName" value="${medPrivate.name}" class="form-control" id="medName" readonly="readonly">
                <input type="text" id="medPrivateId" name="medPrivateId" value="${medPrivate.id}" class="form-control" style="display: none">
                <input type="text" id="iaiLossId" name="iaiLossId" value="${iaiLoss.id}" class="form-control" style="display: none">
                <input type="text" id="lossDetailId" name="lossDetailId" value="${lossDetail.id}" class="form-control" style="display: none">
            ...
            <p>
                ...
                <input type="text" name="standard" value="<c:if test="${not empty medPrivate}">${medPrivate.standard}</c:if>" class="form-control" readonly="readonly" id="standard">
            </p>
        ...
        <div class="content-right text-right">
            <p>
                ...
                <label for="validityDate">有&nbsp;效&nbsp;期</label>
                <input class="form-control" id="validityDate" value="<fmt:formatDate value="${lossDetail.validityDate}" pattern="yyyy/MM/dd"/>" readonly="readonly"/>

            </p>

            <p>
                <label for="lossNumber">损耗数量</label>
                <input type="text" hmp-input-double name="totalNumber" value="${lossDetail.totalNumber}" class="form-control " hmp-input-number id="lossNumber">
            </p>

            <p>
                <label for="medUnit">统计单位</label>
                <%--<input type="text" class="form-control" id="medUnit">--%>
                <select id="medUnit" name="medicineUnit" id="selMedicineUnit" class="form-control" readonly="readonly" disabled="disabled">
...
<div class="text-center" style="margin-top: 15px;">
    <button class="btn btn-success" id="saveLossDetail" type="button" style="width: 80px; margin-right: 5px;">保存</button>
...
<script>
    $(function () {
        ...
        $("#saveLossDetail").click(function () {
            ...
            var url = "${ctx}/IaiLossManage/bombBox/editLossItem";
